...
const GamePage = () => {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col justify-center items-center ">
        <canvas id="canvas" className="bg-white border-4 border-gray-600 block" width={"800"} height={"600"} onMouseDown={handleMouseMove} onMouseMove={handleMouseMove}></canvas>
        <div className="flex ">
